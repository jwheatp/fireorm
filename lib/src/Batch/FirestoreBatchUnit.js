...
var FirestoreBatchUnit = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        op = _a[_i];
                        if (!(op.validateModels && op.type !== 'delete')) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.validate(op.item, op.entity)];
                    case 2:
                        errors = _b.sent();
                        if (errors.length) {
                            throw errors;
                        ...
                        _b.label = 3;
                    case 3:
                        serialized = utils_1.serializeEntity(op.item, op.subCollectionsMetadata);
                        switch (op.type) {
                            case 'create':
    ...
    FirestoreBatchUnit.prototype.add = function (type, item, ref, entity, subCollectionsMetadata, validateModels) {
        this.operations.push({
            type: type,
            item: item,
            ref: ref,
            entity: entity,
            subCollectionsMetadata: subCollectionsMetadata,
